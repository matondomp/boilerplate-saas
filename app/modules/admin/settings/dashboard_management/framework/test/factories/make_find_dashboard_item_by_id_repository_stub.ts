...
export const makeFindDashboardItemByIdRepositoryStub = (): FindDashboardItemByIdRepository => {
  return new (class implements FindDashboardItemByIdRepository {
    async find(_name: string): Promise<DashboardItemEntity | undefined> {

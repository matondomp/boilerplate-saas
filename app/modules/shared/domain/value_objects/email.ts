...
import { EmailError } from '#shared/domain/errors/email_error'
...
export class Email extends ValueObject<EmailProps> {
  ...
  private validate(): Either<
    EmailError.EmailInvalidError | EmailError.EmailRequiredError,
    boolean
  > {
    if (!this.props.email) {
  ...
  static create(
    email: string
  ): Either<EmailError.EmailInvalidError | EmailError.EmailRequiredError, Email> {
